...
## Purpose
Enhance the Account model to support symbol-specific pip value configuration and entry price validation thresholds. This enables accurate pips-to-price conversion for SET_TP_SL commands and validation of AI-inferred entry prices against market prices.
