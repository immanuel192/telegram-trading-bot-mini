...
## Purpose
Define the end-to-end order execution flow from trade-manager publishing order requests to executor-service executing trades and publishing results back. This specification covers the event-driven messaging, order lifecycle tracking, integration between services, and error handling.
