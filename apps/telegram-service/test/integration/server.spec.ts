/**
 * Integration test for telegram-service server bootstrap
...
describe(suiteName(__filename), () => {
  ...
  describe('Server Bootstrap', () => {
    it('should bootstrap the application successfully', async () => {
      ...
      expect(serverContext.container.telegramService).toBeDefined();
    ...
    it('should initialize telegram service', async () => {
      serverContext = await startServer();

      // Verify telegram service is initialized
      const { telegramService } = serverContext.container;
      expect(telegramService).toBeDefined();
      expect(telegramService.connect).toBeDefined();
      expect(telegramService.disconnect).toBeDefined();
